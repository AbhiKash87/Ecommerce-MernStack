      ...
      <div>
        <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <button
              onClick={(e) => {
                navigate('/order-success/669233079bd20c76208a4bb6?payment_intent=pi_3Pc0o7SJq6iHf5n91dEpHA0g&payment_intent_client_secret=pi_3Pc0o7SJq6iHf5n91dEpHA0g_secret_2nrbzgDuZT9pvnfRKyNp87bZU&redirect_status=succeeded')
              }}
              type="submit"
              className="rounded-md my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >

    ...
    <div className="bg-white">
      <div>
        {/* Mobile filter dialog */}
          <MobileFilter filters={filters} sortHandler={sortHandler} filterHandler={filterHandler} setMobileFiltersOpen={setMobileFiltersOpen} mobileFiltersOpen = {mobileFiltersOpen}/>

    ...
    <div className="bg-white">
      <div>
        {/* Mobile filter dialog */}
          <MobileFilter sortHandler={sortHandler} filterHandler={filterHandler} setMobileFiltersOpen={setMobileFiltersOpen} mobileFiltersOpen = {mobileFiltersOpen}/>
              ...
              <div>
                ...
                >
                  ...
                  <div
                    ...
                    aria-current="page"
                    className= {`justify-center relative z-10 m-1 border-1 cursor-pointer border border-white inline-flex items-center ${(index+1)==page?`bg-indigo-600`:` text-black`} px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                  >
                    {index+1}
                    </div>)
                  )}
...
const MobileFilter=({sortHandler,filterHandler,setMobileFiltersOpen,mobileFiltersOpen})=>{
